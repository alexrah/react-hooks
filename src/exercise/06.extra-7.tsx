...
function ErrorFallback({error,resetErrorBoundary}:{error:Error,resetErrorBoundary: (...args:['retry'|'reset',...unknown[]]) => void }){

    return (
        <div className='ErrorFallback'>
            <button onClick={(e) => { e.preventDefault(); resetErrorBoundary('retry'); }}>Try again!</button>
            <button onClick={(e) => { e.preventDefault(); resetErrorBoundary('reset'); }}>Reset!</button>
...
function App() {
  ...
  const resetErrorBoundary = (...args:any[]) => {
      // @ts-ignore
        const [resetType]:['retry'|'reset'] = args
        switch (resetType) {
        case 'reset':
    ...
    return (
        ...
        <div className="pokemon-info-app">
          ...
          <div className="pokemon-info">
              <ErrorBoundary resetKeys={[state.pokemonName]} onReset={resetErrorBoundary} FallbackComponent={ErrorFallback} >
